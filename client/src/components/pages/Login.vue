<template>
  <div class="d-lg-flex half">
    <div class="bg order-1 order-md-2 image"></div>
    <div class="contents order-2 order-md-1">
      <div class="container">
        <div class="row align-items-center justify-content-center">
          <div class="col-md-7">
            <div class="mb-4">
              <h3 v-if="mode == 'login'">Authentifier</h3>
              <h3 v-else>Inscription</h3>
              <p class="mb-4" v-if="mode == 'login'">
                Tu n'a pas de compte ?
                <span class="creer">Créer un compte</span>
              </p>
              <p class="mb-4" v-else>
                Tu a déja un compte ?
                <span class="creer" @click="SwitchToLogin()">Se connecter</span>
              </p>
            </div>
            <form>
              <div class="form-group first" v-if="mode == 'create'">
                <input
                  type="text"
                  class="form-control"
                  id="username"
